...
class PredictionController extends BaseAdminController
{
    ...
    public function settle(): void
    {
        ...
        try {
            ...
            logger('error', 'prediction.settle.failed', ['id' => $id, 'error' => $e->getMessage()]);
    ...
    public function cancel(): void
    {
        ...
        try {
            ...
            logger('error', 'prediction.cancel.failed', ['id' => $id, 'error' => $e->getMessage()]);
