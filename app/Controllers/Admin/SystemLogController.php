...
class SystemLogController extends BaseAdminController
{
    ...
    public function index()
    {
        try {
            ...
            logger()->error('system_log.index.failed', [
                'error' => $e->getMessage()
            ]);
    ...
    public function viewFile()
    {
        try {
            ...
            logger()->error('system_log.view_file.failed', [
                'error' => $e->getMessage(),
                'date' => $date ?? null
            ]);
    ...
    public function downloadFile()
    {
        try {
            ...
            logger()->error('system_log.download_file.failed', [
                'error' => $e->getMessage(),
                'date' => $date ?? null
            ]);
    ...
    public function cleanup()
    {
        try {
            ...
            logger()->info('system_log.cleanup', [
                'days' => $days,
                'deleted' => $deleted,
                'admin_id' => user_id()
            ]);
            ...
            logger()->error('system_log.cleanup.failed', [
                'error' => $e->getMessage()
            ]);
