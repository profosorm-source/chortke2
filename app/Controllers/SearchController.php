...
{
    private \App\Services\GlobalSearchService $globalSearchService;
    private GlobalSearchService $searchService;

    public function __construct(
        
        \App\Services\GlobalSearchService $globalSearchService
    )
    {
parent::__construct();
        $this->searchService = $this->globalSearchService;
