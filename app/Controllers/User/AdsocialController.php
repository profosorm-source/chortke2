...
class AdsocialController extends BaseUserController
{
    ...
    public function start(): void
    {
        try {
            ...
            logger()->error('adsocial.start.failed', ['err' => $e->getMessage()]);
    ...
    public function submit(): void
    {
        try {
            ...
            logger()->error('adsocial.submit.failed', ['err' => $e->getMessage()]);
    ...
    public function store(): void
    {
        ...
        try {
            ...
            logger()->error('adsocial.store.failed', ['err' => $e->getMessage()]);
