...
class BankCardController extends BaseUserController
{
    ...
    public function index(): void
    {
        ...
        try {
            ...
            logger()->error('Bank cards index failed', [
                'user_id' => $userId,
                'error' => $e->getMessage()
            ]);
    ...
    ['card_id' => $card->id]
            ...
            logger()->error('Store bank card failed', [
                'user_id' => $userId,
                'error' => $e->getMessage()
            ]);
    ...
    public function setDefault(): void
    {
        ...
        try {
            ...
            logger()->error('Set default card failed', [
                'user_id' => $userId,
                'card_id' => $cardId,
                'error' => $e->getMessage()
            ]);
...
if ($deleted) {
    ...
    $this->response->json([
        ...
        'message' => 'کارت بانکی با موفقیت حذف شد'
            ...
            logger()->error('Delete bank card failed', [
                'user_id' => $userId,
                'card_id' => $cardId,
                'error' => $e->getMessage()
            ]);
