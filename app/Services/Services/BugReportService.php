...
class BugReportService
{
    ...
    public function submitReport(int $userId, array $data): array
    {
        ...
        // لاگ
        logger('bug_report_submitted', "گزارش باگ #{$id} توسط کاربر {$userId} ثبت شد" . ($isSuspicious ? ' [مشکوک]' : ''), $isSuspicious ? 'warning' : 'info');
    ...
    public function updateStatus(int $id, string $status, int $adminId, ?string $note = null): array
    {
        ...
        logger('bug_report_status_changed', "وضعیت گزارش #{$id} به {$status} تغییر یافت توسط ادمین {$adminId}", 'info');
    ...
    public function updatePriority(int $id, string $priority, int $adminId): array
    {
        ...
        logger('bug_report_priority_changed', "اولویت گزارش #{$id} به {$priority} تغییر یافت", 'info');
    ...
    public function toggleSuspicious(int $id): array
    {
        ...
        logger('bug_report_suspicious_toggle', "گزارش #{$id} به عنوان {$text} علامت‌گذاری شد", 'warning');
    ...
    public function deleteReport(int $id): array
    {
        ...
        logger('bug_report_deleted', "گزارش #{$id} حذف شد", 'warning');
