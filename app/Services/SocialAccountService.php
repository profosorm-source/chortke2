...
class SocialAccountService
{
    ...
    public function register(int $userId, array $data): array
    {
        ...
        // لاگ
        logger('social_account', "User {$userId} registered social account: {$data['platform']}/@{$data['username']}");
    ...
    public function verify(int $accountId, int $adminId): array
    {
        ...
        logger('social_account', "Admin {$adminId} verified social account #{$accountId}");
    ...
    public function reject(int $accountId, int $adminId, string $reason): array
    {
        ...
        logger('social_account', "Admin {$adminId} rejected social account #{$accountId}: {$reason}");
    ...
    public function delete(int $accountId, int $userId): array
    {
        ...
        logger('social_account', "User {$userId} deleted social account #{$accountId}");
