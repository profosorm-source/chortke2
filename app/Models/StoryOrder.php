...
public function find(int $id): ?object
    ...
    public function update(int $id, array $data): bool
    {
        ...
        $allowed = [
            ...
            'proof_screenshot','proof_video','proof_submitted_at','status','rejection_reason',
    ...
    public function globalStats(): object
    {
        $stmt = $this->db->prepare("
            SELECT
                ...
                COUNT(CASE WHEN status IN ('paid','accepted','published','proof_submitted') THEN 1 END) AS active_orders,
