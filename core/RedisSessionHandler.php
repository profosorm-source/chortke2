...
class RedisSessionHandler implements \SessionHandlerInterface
{
    ...
    private function tryConnectRedis(): void
    {
        ...
        try {
            ...
            if (function_exists('logger')) {
                logger('info', 'Session handler: Redis connected');
            }
        } catch (\Throwable $e) {
            $this->redis = null;
            $this->useRedis = false;
            ...
            if (function_exists('logger')) {
                logger('warning', 'Session handler fallback to file: ' . $e->getMessage());
            }
        }
    }
    ...
    private function fallbackToFile(\Throwable $e): void
    {
        if ($this->useRedis) {
            ...
            if (function_exists('logger')) {
                logger('error', 'Redis session error, fallback to file: ' . $e->getMessage());
            }
