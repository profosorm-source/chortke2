...
class CryptoDepositController extends BaseUserController
{
    ...
    public function create(): void
    {
        ...
        try {
            ...
            logger()->error('Crypto deposit create failed', [
                'user_id' => $userId,
                'error' => $e->getMessage()
            ]);
    ...
    public function store(): void
    {
        ...
        try {
            ...
            log_activity(
                ...
                "درخواست واریز {$data['amount']} USDT ({$data['network']})",
            ...
            logger()->error('Crypto deposit store failed', [
                'user_id' => $userId,
                'error' => $e->getMessage()
            ]);
    ...
    public function index(): void
    {
        ...
        try {
            ...
            logger()->error('Crypto deposit index failed', [
                'user_id' => $userId,
                'error' => $e->getMessage()
            ]);
