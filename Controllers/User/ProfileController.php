...
class ProfileController extends BaseUserController
{
    ...
    public function update(): void
    {
        ...
        if ($result) {
            // ✅ اصلاح logger
            logger('Profile updated', ['user_id' => $userId]);
   ...
   public function uploadAvatar(): void
{
    ...
    if (!$result) {
        logger('Avatar update failed', ['user_id' => $userId, 'filename' => $filename]);
        $this->response->json(['success' => false, 'message' => 'خطا در ذخیره‌سازی آواتار در دیتابیس'], 500);
        return;
    }

    logger('Avatar uploaded', ['user_id' => $userId, 'filename' => $filename]);
    ...
    public function deleteAvatar(): void
    {
        ...
        logger('Avatar deleted', ['user_id' => $userId]);
    ...
    public function changePassword(): void
    {
        ...
        if ($result) {
            // ✅ اصلاح logger
            logger('Password changed', ['user_id' => $userId]);
