...
class LevelController extends BaseAdminController
{
    ...
    public function store()
    {
        ...
        log_activity('levels.create', 'ایجاد سطح جدید', ['level_id' => $level->id, 'name' => $data->name, 'slug' => $slug]);
    ...
    public function destroy()
    {
        ...
        log_activity('levels.delete', 'حذف سطح', ['level_id' => $id, 'name' => $level->name, 'slug' => $level->slug]);
