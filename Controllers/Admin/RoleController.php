...
class RoleController extends BaseAdminController
{
    ...
    public function index()
    {
        ...
        log_activity('roles.view', 'مشاهده لیست نقش‌ها');
    ...
    public function store()
    {
        ...
        log_activity('roles.create', 'ایجاد نقش جدید', [
            'role_id'   => $role->id,
            'role_name' => $role->name,
            'role_slug' => $role->slug,
        ]);
    ...
    public function update()
    {
        ...
        log_activity('roles.update', 'ویرایش نقش', [
            'role_id'   => $id,
            'role_name' => $data->name,
        ]);
    ...
    public function delete()
    {
        ...
        log_activity('roles.delete', 'حذف نقش', [
            'role_id'   => $id,
            'role_name' => $role->name,
            'role_slug' => $role->slug,
        ]);
    ...
    public function toggle()
    {
        ...
        log_activity('roles.toggle', "تغییر وضعیت نقش به {$statusText}", [
            'role_id' => $id,
