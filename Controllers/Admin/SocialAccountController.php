...
class SocialAccountController extends BaseAdminController
{
    ...
    public function verify()
    {
        ...
        log_activity('social_account_verify', 'تایید حساب اجتماعی #' . $id, $id, 'social_account');
    ...
    public function reject()
    {
        ...
        log_activity('social_account_reject', 'رد حساب اجتماعی #' . $id . ': ' . $reason, $id, 'social_account');
