...
<div class="content-header d-flex justify-content-between align-items-center">
  <div>
    <h4 class="page-title mb-1"><span class="material-icons text-primary">work_outline</span> Adtask — تسک‌های موجود</h4>
    <p class="text-muted mb-0" style="font-size:12px;">تسک‌های سفارشی را انجام دهید و درآمد کسب کنید</p>
  </div>
  <a href="<?= url('/adtask/my-submissions') ?>" class="btn btn-outline-secondary btn-sm">
...
<div class="col-md-6 col-lg-4 mb-3">
  <div class="card h-100">
    ...
    <div class="card-body d-flex flex-column">
      ...
      <a href="<?= url("/adtask/{$task->id}") ?>" class="btn btn-primary btn-sm mt-auto">
