<?php
// views/admin/seo-keywords/create.php
$title = 'ایجاد کلمه کلیدی';
$layout = 'admin';
ob_start();
$isEdit = false;
$kw = (object)['keyword'=>'','target_url'=>'','target_position'=>0,'scroll_min_seconds'=>25,'scroll_max_seconds'=>40,'pause_min_seconds'=>3,'pause_max_seconds'=>8,'total_browse_seconds'=>60,'max_per_hour'=>3,'max_per_day'=>15,'daily_budget'=>100,'reward_amount'=>0,'priority'=>0,'is_active'=>1];
?>

<div class="page-header">
    <h4><i class="material-icons">add</i> ایجاد کلمه کلیدی</h4>
    <a href="<?= url('/admin/seo-keywords') ?>" class="btn btn-outline-sm"><i class="material-icons">arrow_forward</i> بازگشت</a>
</div>

<div class="card"><div class="card-body">
<form action="<?= url('/admin/seo-keywords/store') ?>" method="POST">
    <?= csrf_field() ?>
    <div class="form-row">
