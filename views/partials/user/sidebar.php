...
<div class="sidebar" id="mainSidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li>
      <a href="<?= url('/my-banners') ?>" class="<?= $active('/my-banners')?'active':'' ?>">
        <span class="material-icons">view_carousel</span><span class="menu-title">Banner</span>
      </a>
    </li>
    <li>
      <a href="<?= url('/online-store') ?>" class="<?= $active('/online-store')&&!$active('/sell')?'active':'' ?>">
        <span class="material-icons">storefront</span><span class="menu-title">Online Store</span>
      </a>
    </li>
    ...
    <li>
      <a href="<?= url('/online-store/sell') ?>" class="<?= $active('/online-store/sell')?'active':'' ?>">
        <span class="material-icons">sell</span><span class="menu-title">فروش پیج/کانال</span>
      </a>
    </li>
    <li>
