...
<aside class="sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav" id="sidebarNav">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item has-sub <?= e($openIf(['/admin/content', '/admin/stories', '/admin/seo-keywords'])) ?>"
                 onclick="toggleAdminSub(this)">
                <span class="material-icons nav-icon">campaign</span>
                <span class="nav-label">محتوا و رسانه</span>
                <span class="material-icons nav-arrow">chevron_left</span>
            </div>
            <div class="nav-submenu <?= e($openIf(['/admin/content', '/admin/stories', '/admin/seo-keywords'])) ?>">
                ...
                <a class="nav-sub-item <?= e($ac('/admin/stories')) ?>" href="<?= url('/admin/stories') ?>">
                    <span class="nav-sub-dot"></span>تبلیغات استوری
                </a>
